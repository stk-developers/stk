...
class NNet{
  private:
    ...
    WindowMatrix mInCache;   ///< Matrix of input vectors
    WindowMatrix outCache;   ///< Matrix of example output vectors
    WindowMatrix compCache;  ///< Matrix of computed output vectors
    Matrix error;            ///< Neural net global output error
